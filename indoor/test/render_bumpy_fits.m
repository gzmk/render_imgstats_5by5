...
writetable(T,'/scratch/gk925/render_imgstats_5by5/indoor/test/bumpy_fitrender_Conditions.txt','Delimiter','\t')

% Set preferences
setpref('RenderToolbox3', 'workingFolder', '/scratch/gk925/render_imgstats_5by5/indoor/test');
