...
for bump = 1:11
    for gloss = 1:11
        for meshCount = 1:22
            ...
            writetable(T,'/scratch/gk925/render_imgstats_5by5/outdoor/LO11/bumpy_fitrender_Conditions.txt','Delimiter','\t')
            
            % Set preferences
            setpref('RenderToolbox3', 'workingFolder', '/scratch/gk925/render_imgstats_5by5/outdoor/LO11');
